...
namespace Enfield.ShopManager.Tests.Installer
{
    public class RepositoryInstallerTests
    {
        ...
        public void RepositoryInstallerSetup()
        {
            ...
            containerWithRepositories.AddFacility<FakePersistenceFacility>();
        }
        ...
        [Test]
        public void Repository_gets_session()
        {
            var repository = containerWithRepositories.Resolve<InvoiceRepository>();
            Assert.IsNotNull(repository.Session);
        }

        [Test]
        public void Repository_gets_session_using_factory()
        {
            var factory = containerWithRepositories.Resolve<IRepositoryFactory>();
            var repository = factory.Create<InvoiceRepository>();
            Assert.IsNotNull(repository.Session);
        }
